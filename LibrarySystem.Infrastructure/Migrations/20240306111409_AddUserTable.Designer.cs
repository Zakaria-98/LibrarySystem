...
namespace LibrarySystem.Migrations
{
    ...
    [Migration("20240306111409_AddUserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibrarySystem.Models.Order", b =>
                {
                    ...
                    b.HasIndex("RestorationId")
                        .IsUnique()
                        .HasFilter("[RestorationId] IS NOT NULL");
            ...
            modelBuilder.Entity("LibrarySystem.Models.Order", b =>
                {
                    ...
                    b.HasOne("LibrarySystem.Models.Restoration", "Restoration")
                        .WithOne("Order")
                        .HasForeignKey("LibrarySystem.Models.Order", "RestorationId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LibrarySystem.Core.Models.User", null)
                        .WithMany()
